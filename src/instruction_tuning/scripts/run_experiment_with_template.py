...
def submit_job_for_experiment(template_path,
    ...
    modified_script = modified_script.replace('sh ./scripts/<tmp>.sh', f'sh ./scripts/{script_name}.sh')
...
# sample command => python run_experiment_with_template.py --exp_name mgpt_ls_random --script_name finetune_lang_selection_random_mgpt_cluster --use_a40
