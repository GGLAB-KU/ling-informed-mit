lang='pl,ps,my,tl,gl,sl,ka,sv,gu,vi,ko,ml,bn,uk'
WORLD_SIZE=1
...
model_alias='mGPT_add_1'
peft_method='lora'
lang_selection='ls_semantic'
...
# evaluate
lm_eval --model hf \
--model_args pretrained=ai-forever/mGPT,peft=${peft_root}${model_alias}-X-${lang_selection}-${peft_method}  \
